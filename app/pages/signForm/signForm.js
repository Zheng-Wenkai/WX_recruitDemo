...
Page({
  ...
  formSubmit: function (e) {
    ...
    if (e.detail.value.fullName == "" || e.detail.value.studentId == "" || e.detail.value.major == "" || e.detail.value.phoneNumber == "" || e.detail.value.introduction == "" || e.detail.value.xueyuan == 0 || e.detail.value.xingbie == 0 || e.detail.value.quyu == 0 || e.detail.value.wishA == 0) {
  ...
  uploadPic: function () {
    ...
    this.data.isuploadpic = true;// 最好放在success里面，但为了防止因未知名错误导致用户无法报名，故外移。
  },
